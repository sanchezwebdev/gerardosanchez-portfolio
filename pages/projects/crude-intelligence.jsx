      ...
      <div className={styles.container}>
        <div className = {styles.topContainer}>
          ...
          />
            ...
            These datasets were stored in a PostgreSQL database using Supabase, and modeled in Django using introspection. I started by using Python to convert the raw CSV files from Kaggle into SQL scripts. Then I set up a PostgreSQL instance on Supabase and ran the SQL scripts against the database using pgAdmin. Finally, I established a connection from  the Django application to the deployed database, enabling it to leverage a scalable, managed backend in production.<br /><br />       
